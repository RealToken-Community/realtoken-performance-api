...
RATE_LIMITER_PARAMS = ["1 per 10 seconds", "8 per hour"]

# Google drive rent files
RENT_FILES_FOLDER_ID = "1hmlw04fNhj-1nN0S493fheLzcZOLai_G"

# Subgraph endpoint
REALTOKEN_GNOSIS_SUBGRAPH_ID = "FPPoFB7S2dcCNrRyjM5QbaMwKqRZPdbTg8ysBrwXd4SP"
RMMV3_WRAPPER_GNOSIS_SUBGRAPH_ID = "2dMMk7DbQYPX6Gi5siJm6EZ2gDQBF8nJcgKtpiPnPBsK"
SWAPCAT_REALTOKEN_GNOSIS_SUBGRAPH_ID = "BC5uHuHf4YybNfQECjvHJyZmEfLrPSUu8fLNMZsQ38jx"
